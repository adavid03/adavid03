...
export default function CollegeAlgebra() {
  return (
      ...
      >
        <div className="text-center space-y-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 blur-xl opacity-20 dark:opacity-30 rounded-3xl" />
            <div className="relative bg-white/50 dark:bg-black/50 backdrop-blur-xl rounded-3xl p-8 border border-black/5 dark:border-white/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-xl bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800">
                  <h3 className="font-medium text-purple-900 dark:text-purple-300 mb-2">Progress Tracking</h3>
                  <p className="text-sm text-purple-700/80 dark:text-purple-400/80">Monitor your learning journey with detailed analytics</p>
                </div>
              </div>
            </div>
          </div>
